...
Required Procedure file contains insertPresentation & LectureInBudapest procedures. Other procedure file contains extra procedures that may be helpful in database.
